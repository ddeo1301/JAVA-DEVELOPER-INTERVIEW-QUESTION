...
// java tells that for child class there should be only 1 parent class
// Interface have abstract methods. Abstract methods are methods without body
interface TeamLead {
    void leadTeam();
}
...
class CEO extends Executive {
    ...
    public void leadCompany() {
        makeExecutiveDecisions();    // DIFFERENCE in hierarical and multilevel
...
//        Specialization: Developer, Programming Language: Java
...
//        HR Director managing the HR department.
         ...
         ceo.leadCompany();
         // OUTPUT
         // Executive making executive decisions.
         //CEO leading the company.
...
//        Business Development Manager coordinating business development efforts.
    }
}
